...
import org.battir.androidtrainingkotlin.databinding.ActivityPermissionsRequestBinding
...
class PermissionsRequestActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityPermissionsRequestBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAllPermissions.setOnClickListener { view ->
        ...
        binding.btnStoragePermission.setOnClickListener { view ->
        ...
        binding.btnCameraPermission.setOnClickListener { view ->
        ...
        binding.btnLocationPermission.setOnClickListener { view ->
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == ALL_PERMISSIONS_CODE) {
            ...
            if (perms[Manifest.permission.ACCESS_FINE_LOCATION] == PackageManager.PERMISSION_GRANTED
                ...
                Toast.makeText(
                    this@PermissionsRequestActivity,
                    "All Permissions granted.",
                    Toast.LENGTH_SHORT
                ).show()
            } else {
